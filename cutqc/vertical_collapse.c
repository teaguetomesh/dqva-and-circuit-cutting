...
void vertical_collapse(char *subcircuit_kron_terms_file, char *eval_folder, char *vertical_collapse_folder, int early_termination, int rank);
...
void vertical_collapse(char *subcircuit_kron_terms_file, char *eval_folder, char *vertical_collapse_folder, int early_termination, int rank) {
    ...
    for (subcircuit_ctr=0;subcircuit_ctr<num_subcircuits;subcircuit_ctr++) {
        ...
        int effective_len = (int) pow(2,num_effective);
        int kron_terms_ctr;
