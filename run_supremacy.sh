...
python generate_evaluator_input.py --min-qubit 12 --max-qubit 12 --max-clusters 3 --device-name ibmq_johannesburg --circuit-type supremacy --shots-mode saturated 2>&1 | tee ./logs/supremacy_generator_logs.txt

echo "Running evaluator"
mpiexec -n 2 python evaluator_prob.py --device-name ibmq_johannesburg --circuit-name supremacy --evaluation-method hardware
