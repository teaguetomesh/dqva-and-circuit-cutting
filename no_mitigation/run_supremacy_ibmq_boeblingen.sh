...
mpiexec -n 5 python generate_evaluator_input.py --min-qubit 2 --max-qubit 9 --max-clusters 3 --device-name ibmq_boeblingen --circuit-type supremacy 2>&1 | tee ./logs/supremacy_ibmq_boeblingen_generator_logs.txt
...
wait $P1 $P2
echo "supremacy ibmq_boeblingen DONE"
