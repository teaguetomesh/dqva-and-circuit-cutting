...
python generate_evaluator_input.py --min-qubit 9 --max-qubit 19 --max-clusters 4 --device-name ibmq_johannesburg --circuit-name bv 2>&1 | tee ./logs/bv_generator_logs.txt
