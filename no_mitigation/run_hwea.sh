...
python generate_evaluator_input.py --min-qubit 9 --max-qubit 9 --max-clusters 3 --device-name ibmq_poughkeepsie --circuit-type hwea --shots-mode saturated 2>&1 | tee ./logs/hwea_generator_logs.txt
