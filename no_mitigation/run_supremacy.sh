...
python generate_evaluator_input.py --min-qubit 9 --max-qubit 19 --max-clusters 4 --device-name ibmq_boeblingen --circuit-name supremacy 2>&1 | tee ./logs/supremacy_generator_logs.txt
