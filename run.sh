...
python -m utils.job_submittor --experiment-name $EXPERIMENT_NAME --device-name $DEVICE_NAME --circuit-type $CIRCUIT_TYPE --evaluation-method $EVALUATION_METHOD --shots-mode saturated
