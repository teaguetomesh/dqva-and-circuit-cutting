...
mpiexec -n 2 python hardware_job_submittor.py --device-name $DEVICE_NAME --circuit-type $CIRCUIT_TYPE --shots-mode saturated 2>&1 | tee ./logs/$CIRCUIT_TYPE\_saturated_$DEVICE_NAME\_hw_job_submittor_logs.txt
...
mpiexec -n 2 python hardware_job_submittor.py --device-name $DEVICE_NAME --circuit-type $CIRCUIT_TYPE --shots-mode sametotal 2>&1 | tee ./logs/$CIRCUIT_TYPE\_sametotal_$DEVICE_NAME\_hw_job_submittor_logs.txt
