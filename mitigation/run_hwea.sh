...
# echo "Running reconstruction"
# python uniter_prob.py --device-name ibmq_johannesburg --circuit-type hwea --shots-mode saturated --evaluation-method noisy_qasm_simulator 2>&1 | tee ./logs/hwea_uniter_logs.txt

# echo "Running sametotal noisy qasm evaluator"
# mpiexec -n 5 python evaluator_prob.py --device-name ibmq_johannesburg --circuit-type hwea --shots-mode sametotal --evaluation-method noisy_qasm_simulator
# echo "Running reconstruction"
# python uniter_prob.py --device-name ibmq_johannesburg --circuit-type hwea --shots-mode sametotal --evaluation-method noisy_qasm_simulator 2>&1 | tee ./logs/hwea_uniter_logs.txt

# echo "Running evaluator evaluator"
# mpiexec -n 5 python evaluator_prob.py --device-name ibmq_johannesburg --circuit-type hwea --evaluation-method statevector_simulator
# echo "Running reconstruction"
# python uniter_prob.py --device-name ibmq_johannesburg --circuit-type hwea --evaluation-method statevector_simulator 2>&1 | tee ./logs/hwea_uniter_logs.txt
