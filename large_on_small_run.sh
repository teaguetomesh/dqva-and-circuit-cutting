...
mpiexec -n 50 python -m utils.reconstructor_parallel --experiment-name large_on_small --device-name ibmq_boeblingen --circuit-type $CIRCUIT_TYPE --evaluation-method statevector_simulator 2>&1 | tee -a ./large_on_small/logs/$CIRCUIT_TYPE\_logs.txt
