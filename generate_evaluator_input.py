...
if __name__ == '__main__':
    ...
    for hw_max_qubit in range(args.min_qubit,args.max_qubit+1):
        for dimension in dimension_l:
            ...
            # Looking for a cut
            searcher_begin = time()
            hardness, positions, ancilla, d, num_cluster, m = searcher.find_cuts(circ,num_clusters=range(1,args.max_clusters+1),hw_max_qubit=hw_max_qubit,evaluator_weight=1)
