...
python generate_evaluator_input.py --min-qubit 2 --max-qubit 8 --max-clusters 4 --device-name ibmq_johannesburg --circuit-name bv 2>&1 | tee ./logs/bv_generator_logs.txt
