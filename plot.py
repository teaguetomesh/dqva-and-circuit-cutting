...
plt.errorbar(num_qubits,ce_metric_avg['qasm+noise+na+cutting'],fmt='X',yerr=ce_metric_err['qasm+noise+na+cutting'],label='qasm+noise+na+cutting')
# plt.yscale('log')
plt.xlabel('supremacy circuit # qubits')
